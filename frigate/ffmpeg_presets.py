...
PRESETS_HW_ACCEL_SCALE = {
    ...
    "preset-rk-h264": "-r {0} -vf scale_rkrga=w={1}:h={2}:force_original_aspect_ratio=0:format=yuv420p,hwmap=mode=read,format=yuv420p",
    "preset-rk-h265": "-r {0} -vf scale_rkrga=w={1}:h={2}:force_original_aspect_ratio=0:format=yuv420p,hwmap=mode=read,format=yuv420p",
